...
- For other installer versions, uninstall the previous version (uninstall.exe for Windows, delete the Application folder on MacOS) and download the latest version to reinstall. User settings and data will remain.
- For other installer versions, uninstall the previous version (uninstall.exe for Windows, delete the Application folder on MacOS) and download the latest version to reinstall. User settings and data will remain.
