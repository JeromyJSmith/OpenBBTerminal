...
<details><summary>How to update the terminal installation?</summary>

- For a `pip` installation, when a new version is published: `pip install -U openbb[all]`
- For other installation methods, follow the specific update instructions provided in the installation documentation.
