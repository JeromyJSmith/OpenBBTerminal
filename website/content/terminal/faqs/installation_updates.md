...
**To update the installation to the latest version:**
- For the Windows installer, if using version 2.4.1 or later, it has an option for uninstalling the existing prior to updating.
